...
#RegDataMnd <- RegData6mnd[which(as.Date(RegData$InnDato, tz='UTC') >= datoFraMnd), ]
...
dum <- RyggFigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='peropKompDura',
                      reshID = reshID, tidsenhet = 'Kvartal', hovedkat = 1,
                      outfile='PeropKompDura_pro.pdf')
dum <- RyggFigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='peropKompDura',
                      reshID = reshID, tidsenhet = 'Kvartal', hovedkat = 9,
...
liggetidKj <- rbind(
      ...
      'Egen'= finnGjsnMedKj(RegDataEget6mnd),
	'Resten av landet'= finnGjsnMedKj(RegDataResten6mnd)) #,
...
dum <- RyggFigAndelTid(RegData=RegData, preprosess=0, valgtVar='kpInf', datoFra = datoFraInf,
                        enhetsUtvalg = 1, reshID = reshID, tidsenhet = 'Kvartal',
                        outfile='KpInf.pdf')
RyggFigGjsnBox(RegData=RegData, preprosess=0, valgtVar='OswEndr',
                       enhetsUtvalg = 1, reshID = reshID, tidsenhet = 'Kvartal',
...
#
# dum <- RyggFigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='kpInf',
#                       reshID = reshID, tidsenhet = 'Kvartal', hovedkat = 1,
#                       outfile='PeropKompDura_pro.pdf')
dum <- RyggFigAndeler(RegData=RegData, preprosess=0, valgtVar='kpInf', enhetsUtvalg = 1,
                       reshID = reshID, outfile='KpInf.pdf')
