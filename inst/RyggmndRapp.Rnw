...
<<'Figurer', results='asis', echo=FALSE>>=
Registreringsforsinkelse
dum <- RyggFigAndeler(RegData=RegData, preprosess=0, valgtVar='regForsinkelse', enhetsUtvalg = 1,
                      outfile='Registreringsforsinkelse.pdf')
dum <- RyggFigAndeler(RegData=RegData, preprosess=0, valgtVar='peropKompDura', enhetsUtvalg = 1,
                      outfile='peropKompDura.pdf')
dum <- RyggFigAndeler(RegData=RegData, preprosess=0, valgtVar='sympVarighUtstr', enhetsUtvalg = 1,
                      outfile='SymptVarighUtstrTilBen.pdf')

@

\begin{figure}[ht]
\centering              
\includegraphics[scale=0.35]{Registreringsforsinkelse.pdf}
...
\caption{Peroperativ komplikasjon; durarift, egen avdeling og resten av landet.}
\end{figure}
\end{frame}
